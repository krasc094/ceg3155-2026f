...
begin
  ...
  -- MSB and LSB have to be different for shift extension
  -- rightmost
  mux_lsb: mux4_1bit
  port map (
    a => int_q(0),
...
begin
  ...
  process begin
    ...
    wait for clock_period / 2; -- rising
    assert o_tb = "0101" report "shift left failed"; 
    ...
    shiftR_TB <= '0';
    wait for clock_period / 2; -- rising
    assert o_tb = "0010" report "shift right failed"; 
